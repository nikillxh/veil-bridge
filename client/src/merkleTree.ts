import { poseidon, ZERO_VALUE } from "./poseidon.js";
...
/// Fixed-depth Poseidon Merkle tree that mirrors the on-chain
/// `MerkleTreeWithHistory` exactly (same ZERO_VALUE, same Poseidon, same
/// left/right ordering), so a path computed here verifies in the circuit and
/// resolves to the same root the relayer bridged to QIE.
