export function BackdropFX() {
  return (
    <div aria-hidden className="pointer-events-none fixed inset-0 z-0 overflow-hidden">
      ...
      <div className="absolute -right-40 top-20 h-[30rem] w-[30rem] rounded-full bg-iris-600/20 blur-[150px]" />
      <div className="absolute bottom-[-12rem] left-1/3 h-[28rem] w-[28rem] rounded-full bg-iris-500/10 blur-[160px]" />
    </div>
  );
}
